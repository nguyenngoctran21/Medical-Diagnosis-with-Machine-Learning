...
print(f'Giá trị name nhận từ dòng lệnh: {name_value}')
...
print(gs_log_reg.best_params_['solver'])
...
output_file_name = f'model_{args.name}_C_{args.C}_solver_{args.solver}_{current_time}.txt'
...
with open(output_file_path, 'w') as file:
    ...
    file.write(f"Tên giải thuật: {args.name}\n")
